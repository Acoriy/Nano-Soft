...
const HRSystem = () => {
  return (
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8  pt-28  md:pt-32">
       {/* Open Graph  */}
       <SEO
        title="نانو سوفت - نظام إدارة الموارد البشرية"
        description="نظام متكامل لإدارة الموارد البشرية مصمم خصيصاً للشركات والمؤسسات في ليبيا والعالم العربي"
        image={ImageOg}
        category="HR Software"
        keywords="نظام إدارة الموارد البشرية , برنامج شؤون الموظفين , حلول HR متكاملة , إدارة الرواتب والحضور , نظام متكامل لشؤون العاملين"
        url="https://nanosoft.ly/hr"
      />
