...
const InventorySystem = () => {
  ...
  return (
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8 pt-28  md:pt-32">
      {/* Open Graph  */}
      <SEO
        title="نانو سوفت - نظام إدارة المخزون والمستودعات"
        ...
        keywords="برنامج إدارة المخزون , نظام مراقبة المخزون , حلول إدارة المستودعات , برنامج الجرد الذكي , إدارة المخزون والمشتريات"
